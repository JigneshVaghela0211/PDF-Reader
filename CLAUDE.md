...
- **Text selection over rendered pages** is a custom gesture bridge (`TextSelectionOverlay`/`TextSelectionToolbar`) mapping touch bounds to PDFBox `TextWord` rects — there is no native OS text selection on rendered bitmaps.
