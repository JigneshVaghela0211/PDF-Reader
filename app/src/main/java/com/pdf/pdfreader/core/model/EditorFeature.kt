...
enum class EditorFeature(
    ...
    OCR_EDIT(FeatureCategory.PDF_TOOLS, "OCR Text Edit"),
    BATCH_OCR(FeatureCategory.PDF_TOOLS, "Batch OCR"),
    OCR_SEARCH(FeatureCategory.PDF_TOOLS, "OCR Search"),
    OCR_EXPORT(FeatureCategory.PDF_TOOLS, "OCR Export"),
